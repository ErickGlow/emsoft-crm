...
export function WonForm({ open, onClose }: { open: boolean; onClose: () => void }) {
  ...
  return (
    <Drawer
      open={open} onClose={onClose} title="Log Won Project"
    ...
    >
      <form onSubmit={handleSubmit} className="space-y-4">
        <div><Label>Project title</Label><Input value={title} onChange={(e) => setTitle(e.target.value)} autoFocus /></div>
